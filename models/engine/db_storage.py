...
class DBStorage:
    ...
    def __init__(self):
        """Method to instantiate a DBStorage object"""
    ...
    def all(self, cls=None):
        """Method to query the database session that is currently on"""
        newest_dict = {}
        for clss in classes:
    ...
    def new(self, obj):
        """Method to add an object to the current database session"""
    ...
    def reload(self):
        """Method that reloads database data"""
